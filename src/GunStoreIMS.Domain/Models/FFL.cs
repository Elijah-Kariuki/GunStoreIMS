...
namespace GunStoreIMS.Domain.Models
{
    ...
    public class FFL : IValidatableObject
    {
        ...
        public bool RemoveAcquisition(Acquisition acq) => _acquisitions.Remove(acq);

        public void AddDisposition(Disposition disp)
        {
            if (disp == null) throw new ArgumentNullException(nameof(disp));
            _dispositions.Add(disp);
        }

        public bool RemoveDisposition(Disposition disp) => _dispositions.Remove(disp);
